...
def main():
    ...
    subprocess.call('dpkg-scanpackages pool >'
                    ' dists/trusty/main/binary-amd64/Packages', shell=True)
    subprocess.call('gzip < dists/trusty/main/binary-amd64/Packages'
                    ' > dists/trusty/main/binary-amd64/Packages.gz', shell=True)
    update_release()
